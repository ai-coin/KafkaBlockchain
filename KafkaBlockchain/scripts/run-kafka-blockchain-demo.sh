...
echo demonstrate putting messages into a Kafka blockchain named kafka-demo-blockchain-2
...
echo demonstrate consuming messages from the Kafka blockchain named kafka-demo-blockchain-2
mvn "-Dexec.args=-classpath %classpath com.ai_blockchain.samples.KafkaBlockchainDemoVerification" -Dexec.executable=java -Dexec.classpathScope=runtime org.codehaus.mojo:exec-maven-plugin:1.5.0:exec
